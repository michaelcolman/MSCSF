...
void set_arguments(int Narg, char *argin[], Argument_parameters *A, char const *Version, FILE *out)
{
	...
	while (counter < Narg) // loop until Number of arguments has been reached
	{
		...
		else if (strcmp(argin[counter], "Results_Reference") == 0 || strcmp(argin[counter], "results_reference") == 0 || strcmp(argin[counter], "Results_reference") == 0 || strcmp(argin[counter], "results_ref") == 0 || strcmp(argin[counter], "Results_ref") == 0) // if there is no difference between argument and "BCL"
		{
		...
		else if (strcmp(argin[counter], "State_Reference_read") == 0 || strcmp(argin[counter], "state_reference_read") == 0 || strcmp(argin[counter], "state_ref_read") == 0 || strcmp(argin[counter], "State_ref_read") == 0) // if there is no difference between argument and "BCL"
		{
		...
		else if (strcmp(argin[counter], "State_Reference_write") == 0 || strcmp(argin[counter], "state_reference_write") == 0 || strcmp(argin[counter], "state_ref_write") == 0 || strcmp(argin[counter], "State_ref_write") == 0) // if there is no difference between argument and "BCL"
		{
		...
		else if (strcmp(argin[counter], "Spatial_output_interval_vtk") == 0)
		{
		...
		else if (strcmp(argin[counter], "Spatial_output_interval_data") == 0)
		{
        ...
        else if (strcmp(argin[counter], "Spatial_output_range_start") == 0)
        {
        ...
        else if (strcmp(argin[counter], "Spatial_output_range_end") == 0)
        {
		...
		else if (strcmp(argin[counter], "Multi_stim") == 0)
		{
		...
		else if (strcmp(argin[counter], "ACh") == 0)
		{
		...
		else if (strcmp(argin[counter], "ACh_model") == 0)
		{
		...
		else if (strcmp(argin[counter], "Remodelling_proportion") == 0)
		{
		...
		else if (strcmp(argin[counter], "Agent_proportion") == 0)
		{
		...
		else if (strcmp(argin[counter], "Spatial_gradient") == 0)
		{
		...
		else if (strcmp(argin[counter], "Spatial_gradient_proportion") == 0)
		{
		...
		else if (strcmp(argin[counter], "Tissue_order") == 0)
		{
		...
		else if (strcmp(argin[counter], "Tissue_model") == 0)
		{
		...
		else if (strcmp(argin[counter], "Tissue_type") == 0)
		{
		...
		else if (strcmp(argin[counter], "Orientation_type") == 0)
		{
		...
		else if (strcmp(argin[counter], "D_uniformity") == 0)
		{
		...
		else if (strcmp(argin[counter], "Stimulus_location_type") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_Stimulus_location_type") == 0)
		{
		...
		else if (strcmp(argin[counter], "Dscale") == 0)
		{
		...
		else if (strcmp(argin[counter], "D_AR_scale") == 0)
		{
		...
		else if (strcmp(argin[counter], "Multiple_models") == 0)
		{
		...
		else if (strcmp(argin[counter], "Tissue_model_2") == 0)
		{
		...
		else if (strcmp(argin[counter], "S1_shape") == 0)
		{
		...
		else if (strcmp(argin[counter], "S1_x_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "S1_x_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "S1_y_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "S1_y_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "S1_z_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "S1_z_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_shape") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_x_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_x_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_y_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_y_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_z_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "S2_z_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "D1") == 0)
		{
		...
		else if (strcmp(argin[counter], "D_AR") == 0)
		{
		...
		else if (strcmp(argin[counter], "dx") == 0)
		{
		...
		else if (strcmp(argin[counter], "OX") == 0)
		{
		...
		else if (strcmp(argin[counter], "OY") == 0)
		{
		...
		else if (strcmp(argin[counter], "OZ") == 0)
		{
		...
		else if (strcmp(argin[counter], "Global_orientation_direction") == 0)
		{
		...
		else if (strcmp(argin[counter], "Dscale_mod_map") == 0)
		{
		...
		else if (strcmp(argin[counter], "D_AR_scale_mod_map") == 0)
		{
		...
		else if (strcmp(argin[counter], "Remodelling_map") == 0)
		{
		...
		else if (strcmp(argin[counter], "ISO_map") == 0)
		{
		...
		else if (strcmp(argin[counter], "ACh_map") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_map") == 0)
		{
		...
		else if (strcmp(argin[counter], "Direct_modulation_map") == 0)
		{
		...
		else if (strcmp(argin[counter], "map_shape") == 0)
		{
		...
		else if (strcmp(argin[counter], "map_in_type") == 0)
		{
		...
		else if (strcmp(argin[counter], "map_x_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "map_x_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "map_y_loc") == 0)
		{
		...
		else if (strcmp(argin[counter], "map_y_size") == 0)
		{
		...
		else if (strcmp(argin[counter], "map_z_loc") == 0)
		{
        ...
        else if (strcmp(argin[counter], "map_z_size") == 0)
        {
		...
		else if (strcmp(argin[counter], "stim_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "S2_stim_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "phase_file") == 0)
        {
        ...
        else if (strcmp(argin[counter], "Dscale_base_map_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "Dscale_mod_map_file") == 0)
        {
        ...
        else if (strcmp(argin[counter], "D_AR_scale_base_map_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "D_AR_scale_mod_map_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "ISO_map_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "remod_map_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "ACh_map_file") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_map_file") == 0)
        {
        ...
        else if (strcmp(argin[counter], "Direct_modulation_map_file") == 0)
        {
        ...
        else if (strcmp(argin[counter], "Spatial_gradient_map_file") == 0)
        {
		...
		// Spatial cell models ==============================================\\|
		else if (strcmp(argin[counter], "Cell_size") == 0)
        {
		...
		else if (strcmp(argin[counter], "Sim_cell_size") == 0)
        {
		...
		else if (strcmp(argin[counter], "Cai") == 0)
        {
		...
		else if (strcmp(argin[counter], "CaSR") == 0)
        {
		...
		else if (strcmp(argin[counter], "RyR_Po") == 0)
        {
		...
		else if (strcmp(argin[counter], "LTCC_Po") == 0)
        {
		...
		else if (strcmp(argin[counter], "Detub") == 0)
        {
        ...
        else if (strcmp(argin[counter], "LTCC_redist") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
		...
		else if (strcmp(argin[counter], "TT_map_file") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
        ...
        else if (strcmp(argin[counter], "SERCA_het") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
        ...
        else if (strcmp(argin[counter], "SERCA_map_file") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
        ...
        else if (strcmp(argin[counter], "NCX_het") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
        ...
        else if (strcmp(argin[counter], "NCX_map_file") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
        ...
        else if (strcmp(argin[counter], "RyR_het") == 0)
        {
        ...
        else if (strcmp(argin[counter], "RyR_het_map_file") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
        ...
        else if (strcmp(argin[counter], "LTCC_het") == 0)
        {
        ...
        else if (strcmp(argin[counter], "LTCC_map_file") == 0)
        {
            printf("ERROR: \"%s\" functionality is not included in this version. Please check https://github.com/michaelcolman/ for releases which include this functionality (which may only be released after publication of related works)\n\n", argin[counter]);
            exit(1);
        ...
        else if (strcmp(argin[counter], "volds_het") == 0)
        {
		...
		else if (strcmp(argin[counter], "tau_ss_type") == 0)
        {
		...
		else if (strcmp(argin[counter], "Delayed_CaSR_IC") == 0)
		{
		...
		else if (strcmp(argin[counter], "CaSR_IC_delay") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_mode") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_model") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_Pset") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_het") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_DC_PSCRE") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_DC_CF") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_DC_ti_sep") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_DC_ti_W1") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_DC_ti_W2") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_DC_MD") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_DC_duration_W") == 0)
		{
		...
		else if (strcmp(argin[counter], "SRF_Dyn_PSCR_threshold") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_CaSR_max") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_CaSR_Prange") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_ti_sep_max") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_ti_sep_min") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_ti_width_max") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_ti_width_min") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_MD_max") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_MD_min") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_duration_width_max") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_duration_width_min") == 0)
        {
		...
		else if (strcmp(argin[counter], "SRF_Dyn_H") == 0)
        {
		...
		else if (strcmp(argin[counter], "IClb_scale") == 0)
		{
		...
		else if (strcmp(argin[counter], "IKACh_scale") == 0)
		{
		...
		else if (strcmp(argin[counter], "IKACh_va_tau_scale") == 0)
        {
		...
		else if (strcmp(argin[counter], "IK1_Erev_shift") == 0)
        {
		...
		else if (strcmp(argin[counter], "IKACh_va_ss_shift") == 0)
        {
        ...
        else if (strcmp(argin[counter], "IKACh_va_tau_shift") == 0)
        {
		...
		else if (strcmp(argin[counter], "IKACh_va_ss_kscale") == 0)
        {
        ...
        else if (strcmp(argin[counter], "Settings_file") == 0)
        {
            if (counter > 1) 
            {
